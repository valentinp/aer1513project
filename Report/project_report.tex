...
\begin{figure}
    ...
    \caption{Effect of nullspace projection on MSCKF performance. The correlation between the measurement error and the state causes the filter to behave very poorly after a small number of time steps.}
    \label{fig:nullspace}
\end{figure}
...
\begin{figure}
    \centering
    \subfigure {
        \includegraphics[width=0.48\textwidth]{figs/6-Way-Comparison-Feat-Density-1215-1715-Trans}
        \label{fig:comp_3:trans_err}
    }

    \subfigure {
        \includegraphics[width=0.48\textwidth]{figs/6-Way-Comparison-Feat-Density-1215-1715-Rot}
        \label{fig:comp_3:rot_err}
    }

    \caption{Comparison of MSCKF, SWF, and IMU integration for three different synthetic maps generated based on the imu data in the dataset interval $k\in[1215,1715]$. The numbers next to ``MSCKF'' and ``SWF'' refer to the amount of features in the dataset (20, 40 or 60).}
    \label{fig:comp_3}
\end{figure}
