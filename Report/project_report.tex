...
\begin{figure}[t]
    ...
    \caption{The hand-held sensor head used in our experiments with the ``Starry Night'' dataset. An IMU reports translational and rotational velocities, while a stereo camera observes point features. We artificially blinded the stereo camera by using measurements from the left camera only.}
...
We would like to thank Professor Timothy D. Barfoot for the use of the \textit{Starry Night Dataset} that was prepared for the graduate state estimation course, AER1513, at the University of Toronto.
%\vspace{8pt}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
