...
\begin{table*}[t]
  ...
  \begin{tabular}{*{11}{c}}
              && \multicolumn{4}{c}{MSCKF} & & \multicolumn{4}{c}{SWF (25)} \B \\ \cline{3-6} \cline{8-11}
...
In environments with more features, both algorithms provide substantial gains over pure IMU integration, al though the SWF significantly outperformed the MSCKF in terms of accuracy on the datasets we tested.
...
Although the SWF appears to be more accurate than the MSCKF, 
