...
\begin{figure}
    ...
    \caption{Comparison of cumulative Root Mean Squared Error (RMSE) of MSCKF, SWF, and IMU integration for three different synthetic maps generated based on the IMU data in the dataset interval $k\in[1215,1715]$. The numbers next to ``MSCKF'' and ``SWF'' refer to the number of features in the dataset (20, 40 or 60).}
    \label{fig:comp_3}
\end{figure}
