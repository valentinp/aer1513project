...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{abstract}
Accurate and consistent state estimation is an important part of autonomous vehicles. The combination of visual and inertial sensors provides
\end{abstract}
...
Table [TABLETABLETABLE] provides summary statistics of each algorithm's performance on the synthetic datasets.

\begin{table*}[t]
  \centering
    \caption{Comparison of root mean squared error (RMSE) and Normalized Estimation Error Squared (NEES) of the MSCKF and SWF for three different synthetic maps generated based on the IMU data in the dataset interval $k\in[1215,1715]$.}
  \begin{tabular}{*{7}{c}}
    \hline
Feature Count & MSCKF Position RMSE & MSCKF Rotation RMSE & MSCKF NEES & SWF Position RMSE & SWF Rotation RMSE & SWF NEES \\ \hline
40            & 0.2672              & 0.1378              & 10.179     & 0.1750            & 0.0495            & 2280     \\
60            & 0.2550              & 0.1247              & 12.03      & 0.1687            & 0.0377            & 2093     \\
100           & 0.2304              & 0.0952              & 16.755     & 0.1755            & 0.0481            & 2013     \\ \hline
  \end{tabular}
\end{table*}
...
\begin{tabular}{*{3}{c}}
\hline
Map Size & MSCKF Run Time [s] & SWF 25 Run Time [s]   \\ \hline
40       & 12.19          & 114.3            \\
60       & 14.64          & 175.9            \\
100      & 20.58          & 245.3           \\ \hline
\end{tabular}
\end{table}
...
In environments with more features, both algorithms provide substantial gains over pure IMU integration, although the SWF significantly outperformed the MSCKF on the datasets we tested.
...
It is unclear from these results which algorithm would perform best in the limit of infinite features.

[Something something consistency NEES]

It is worth noting that although the SWF achieved superior accuracy in most cases, the computational effort it required was significantly greater than for the MSCKF.
