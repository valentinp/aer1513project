...
Except where otherwise noted (i.e., state parametrization and integration method), we implemented the MSCKF as presented in \cite{Mourikis:2006:TechReport, Mourikis:2007:ICRA}.
...
To accommodate this alternative sensor configuration, the mathematical framework described in this section differs slightly from \cite{Mourikis:2006:TechReport, Mourikis:2007:ICRA}.
