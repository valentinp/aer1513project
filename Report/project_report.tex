...
On the datasets we tested, the SWF slightly outperformed the MSCKF, however, the accuracy of the MSCKF improved as more features were added while the SWF was less sensitive to feature quantity.
