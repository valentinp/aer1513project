...
Finally, we investigated the effect of feature density on the performance of both the MSCKF and SWF.
For this experiment, we modified the ``Starry Night'' dataset by creating synthetic feature distributions with larger spatial extents and more features than the original dataset.
We retained the original IMU data, but simulated camera measurements with lower measurement noise.
