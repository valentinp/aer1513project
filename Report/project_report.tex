...
Li and Mourikis \cite{Li:2013coa} showed that the Jacobians in the linearized model of a VINS have different observability properties than the actual nonlinear system, reducing the reliability of such estimators.
...
Except where otherwise noted (i.e., state parametrization in \ref{sec:state_parametrization} and integration method in \ref{sec:imu_prop}), we implemented the MSCKF as presented in \cite{Mourikis:2006:TechReport, Mourikis:2007:ICRA}.
