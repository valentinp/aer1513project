...
\author{Lee Clement, Valentin Peretroukhin, and Jacob Lambert% <-this % stops a space
%\thanks{*This work was not supported by any organization}% <-this % stops a space
\thanks{All authors are at the Institute for Aerospace Studies,
        University of Toronto, Canada
        {\tt \{lee.clement, valentin.peretroukhin, jacob.lambert\} @robotics.utias.utoronto.ca}
        }%
}
...
The MSCKF is a hybrid estimator that combines the accuracy of the SWF with the computational efficiency of an Extended Kalman Filter (EKF).
