...
The correlation between the measurement error on the state causes the filter to behave very poorly after a small number of time steps.
...
\begin{figure}
    \centering
    \subfigure {
        \includegraphics[width=0.48\textwidth]{figs/Comparison-Trans-Error}
        \label{fig:comp_1:trans_err}
    }

    \subfigure {
        \includegraphics[width=0.48\textwidth]{figs/Comparison-Rot-Error}
